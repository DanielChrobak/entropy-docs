...
- 2/3 are equally distributed to the top 80% of miners
- 1/3 is distributed to the bottom 20% of miners, where amount of reward per miner decreases linearly with decreasing rank
